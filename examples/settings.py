...
SECRET_KEY = 'm-(l]X/d\/<HPzbPBbsv+U]I^xj.tR+BlZSbcZ/_2QsJsEoAe?'
...
SIMPLECONTENT_ROOT = os.path.join(PROJECT_ROOT, "content")
SIMPLECONTENT_TEMPLATEMANAGER = 'django_simplecontent.template.Jinja2TemplateManager'
SIMPLECONTENT_LIVE_PROCESSORS = (
	'django_simplecontent.processors.LastModifiedProcessor',
)
SIMPLECONTENT_STATIC_PROCESSORS = (
